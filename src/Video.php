...
/*
* @Descripttion: 视频去水印 改https://github.com/5ime/Video_spider
* @Author: jiosen <4631458@qq.com>
* @Date: 2023-06-07 10:37:56
*/
...
class Video {
    ...
    public function watermark($url)
    {
        ...
        return call_user_func_array([$this,$method],[$url]);
    ...
    public function down($url,$filename)
    {
        ...
        $res = call_user_func_array([$this,$method],[$url]);

        if(empty($res) ||  200 != $res['code'] || empty($res['data']['url'])){
            return false;
        }

        return file_put_contents($filename,$this->curl($res['data']['url']));
    }
